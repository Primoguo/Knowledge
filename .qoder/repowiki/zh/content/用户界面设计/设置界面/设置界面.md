...
## 更新摘要
**已进行的更改**
- 修复了 ForEach 循环中的 guard return 语句以防止运行时错误
- 更新了语音引擎选择界面，根据设备能力过滤不支持的引擎
- 将 Apple Neural TTS 标记为推荐选项
- 增强了设备兼容性检查和用户引导体验
...
**图表来源**
- [Views/SettingsView.swift:1-192](file://Views/SettingsView.swift#L1-L192)
...
- [Models/VoiceConfig.swift:1-64](file://Models/VoiceConfig.swift#L1-L64)
...
**图表来源**
- [Views/SettingsView.swift:158-190](file://Views/SettingsView.swift#L158-L190)
...
- 分组与布局
  ...
  - **更新** 语音引擎：列出 TTSEngine 选项，使用 `isSupported` 属性过滤不支持的引擎；Knowledge Voice 显示"即将推出"标签；Apple Neural TTS 标记为"推荐"选项
...
**图表来源**
- [Views/SettingsView.swift:129-135](file://Views/SettingsView.swift#L129-L135)
- [Views/SettingsView.swift:158-190](file://Views/SettingsView.swift#L158-L190)
- [ViewModels/SpeakerViewModel.swift:177-187](file://ViewModels/SpeakerViewModel.swift#L177-L187)
...
**图表来源**
- [Services/ThemeManager.swift:10-23](file://Services/ThemeManager.swift#L10-L23)
- [Views/SettingsView.swift:176-190](file://Views/SettingsView.swift#L176-L190)
...
- [Services/CosyVoiceService.swift:1-219](file://Services/CosyVoiceService.swift#L1-L219)
- [Services/ThemeManager.swift:1-25](file://Services/ThemeManager.swift#L1-L25)
- [Models/VoiceConfig.swift:26-33](file://Models/VoiceConfig.swift#L26-L33)
...
- **新增** 用户体验优化
  - Apple Neural TTS 作为推荐选项，提供更好的音质和离线支持
  - 清晰的引擎描述帮助用户理解各选项差异
...
- **新增** 设备兼容性问题
  - 现象：iOS < 17 设备上无法选择 Apple Neural TTS
  - 处理：这是预期行为，系统会自动过滤不支持的引擎选项
- 配置丢失
  - 现象：重启后设置未生效
...
## 结论
设置模块以清晰的分组与响应式数据流为核心，结合统一的配置持久化与错误处理，提供了良好的可扩展性与用户体验。**最新更新**增强了设备兼容性检查和用户引导体验，通过智能过滤不支持的引擎选项和推荐最佳选择，显著提升了应用的稳定性和用户满意度。通过模块化设计与明确的职责边界，新增设置项与自定义配置界面可以低成本接入现有体系。
...
- **新增** 如需添加新引擎，请在 TTSEngine 中定义并实现 isSupported 属性

**章节来源**
- [Views/SettingsView.swift:158-190](file://Views/SettingsView.swift#L158-L190)
- [Models/VoiceConfig.swift:36-63](file://Models/VoiceConfig.swift#L36-L63)
- [ViewModels/SpeakerViewModel.swift:177-187](file://ViewModels/SpeakerViewModel.swift#L177-L187)
- [Models/VoiceConfig.swift:26-33](file://Models/VoiceConfig.swift#L26-L33)
...
**章节来源**
- [Models/VoiceConfig.swift:50-63](file://Models/VoiceConfig.swift#L50-L63)
- [Services/ErrorHandler.swift:21-35](file://Services/ErrorHandler.swift#L21-L35)
...
**章节来源**
- [Models/VoiceConfig.swift:26-33](file://Models/VoiceConfig.swift#L26-L33)
- [Views/SettingsView.swift:42](file://Views/SettingsView.swift#L42)